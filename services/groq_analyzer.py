...
from services.forensic_hybrid import apply_verdict_score_band_consistency
from services.issuer_contact_hints import build_issuer_contact_hints
from services.tavily_search import _SNIPPET_CONTACT
...
def analyze_document(*, filename: str, content_type: str, file_bytes: bytes) -> dict[str, Any]:
    ...
    try:
        from services.tavily_search import run_queries, QuerySpec
